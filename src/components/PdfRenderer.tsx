...
const PdfRenderer = ({ url }: PdfRendererProps) => {
    ...
    return (
        <div className="w-full bg-white rouded-md shadow flex flex-col items-center">
            <div className="h-14 w-full border-zinc-200 flex items-center justify-between px-2">
